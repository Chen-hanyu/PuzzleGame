...
public final class ActivityLoginChyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLoginChyBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static ActivityLoginChyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLoginChyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_login_chy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLoginChyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginChyBinding((FrameLayout) rootView, loginButton, passwordInput,
          progressBar, registerButton, usernameInput);
    }
